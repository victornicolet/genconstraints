...
CSV_HEADER = "id,numpoints,numweights,numvars,numclauses,numclusters.timeout,time(solve),time(encode),time(cluster),memory"
...
def bench():
    ...
    for benchmark in all_benchmarks:
        ...
        print(ccs_instance)
        results.append([ccs_instance.file, len(ccs_instance.weights), len(ccs_instance.data_points),
